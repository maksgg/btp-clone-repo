		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Hello World Git App Title",
									"targetURL": "#sapbtphelloworldclone-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"sapbtphelloworldclone-display": {
								"semanticObject": "sapbtphelloworldclone",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=sap.btp.helloworldclone",
									"url": sap.ui.require.toUrl("sap/btp/helloworldclone")
								}
							}
						}
					}
